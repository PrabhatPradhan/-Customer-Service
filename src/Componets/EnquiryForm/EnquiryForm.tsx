...
export default function EnquiryForm() {
  ...
  useEffect(() => {
    if (show) {
      // Trigger animation slightly after rendering
        ...
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/50">
          ...
          >
            ...
            <button
              ...
              className="absolute top-10 right-10   text-black-600 hover:text-red-500 text-xl"
              aria-label="Close"
            >
              <FaTimes />
            </button>
            ...
            <div className="space-y-6 bg-orange-100">
              ...
              <div className="pt-4 pb-2 pl-4 text-sm">
                <p className="flex items-center text-black-600 font-semibold">
                  <FaPhoneAlt className="mr-2" /> Call Us:{" "}
                  <span className="ml-1 font-bold">8800542270</span>
                </p>
                <p className="flex items-center text-black-600 font-semibold mt-1">
