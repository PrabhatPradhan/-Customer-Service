  ...
  return (
    <>
      <section className="flex items-center   justify-around flex-col pb-2 md:flex-row   gap-0 px-6 md:px-20 py-6 bg-[#f0f6fc] relative overflow-hidden">
        {/* Left Content */}
        <div className="max-w-xl z-10 px-6 md:px-0">
        ...
        <div className="relative w-[40rem] h-[550px] flex items-center justify-center bg-blue-50 overflow-hidden hidden md:flex">
          {/* Dotted Circle SVG */}
          <svg
            className="absolute"
            width={radius * 2 + 100}
